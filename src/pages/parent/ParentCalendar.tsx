...
export function ParentCalendar() {
  ...
  const selectedEvents = events.filter(
    (e) => e.date === selectedDate && (selectedChildId === '' || e.childId === selectedChildId)
  );
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="Calendar" subtitle="View your children's schedule and important dates" />
              ...
              <div className="space-y-3">
                {selectedEvents.map((event) => (
                  ...
                  >
                    ...
                    {event.childName && (
                      <p className="text-xs text-gray-600 dark:text-gray-300">{event.childName}</p>
                    )}
                    {event.courseName && (
